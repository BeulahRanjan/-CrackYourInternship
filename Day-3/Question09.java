// Question 09-Copy List with Random Pointer
...
// new node has its value set to the value of its corresponding original node. Both the next and random pointer of 
// the new nodes should point to new nodes in the copied list such that the pointers in the original list and copied 
...
// of [val, random_index] where:val: an integer representing Node.val
